...
def complete_gpt2(prompt, l=10, model_name='gpt2-xl', num_log_probs=None, echo=False):
    ...
    if l > 0:
        ...
        total_sequences = gpt2_model.generate(input_ids=input_ids['input_ids'], attention_mask=input_ids['attention_mask'], max_length=l + len(input_ids['input_ids'][0]), do_sample=False)
    else:
...
def construct_prompt(params, train_sentences, train_labels, test_sentence):
    ...
    # print(type(prompt), 200, prompt)
    q_prefix = params["q_prefix"]
    # print(type(q_prefix), 203)
    a_prefix = params["a_prefix"]
    # print(type(a_prefix), 205)
    ...
    # print(type(prompt), 221, prompt)
    prompt += q_prefix
    # print(type(prompt), 223, prompt)
    # print(type(test_sentence), 224, test_sentence)
